 ...
 * literal </xmp> closing tag in both cases, since browsers end the block
 * on either spelling. Run under PHP's built-in server (php -S),
...
echo $xmpWrap->invoke(null, '</xmp><script>alert(1)</script></XMP><script>alert(2)</script>');
