...
In addition to the methods below, you can customize the defaults by adding the following to the top of your script or[SmartStringTest.php](tests/SmartStringTest.php)
in an init file:
